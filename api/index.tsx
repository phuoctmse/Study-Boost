...
const config = {
  ...
  collections: {
    ...
    studySchedules: process.env.EXPO_PUBLIC_APPWRITE_COL_STUDY_SCHEDULE_ID as string,
    weeklyPlans: process.env.EXPO_PUBLIC_APPWRITE_COL_WEEKLY_PLAN_ID as string,
    dailySessions: process.env.EXPO_PUBLIC_APPWRITE_COL_DAILY_SESSION_ID as string,
